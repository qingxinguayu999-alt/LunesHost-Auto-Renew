...
Never include a real email address, password, Telegram Bot Token, Telegram Chat ID, cookie, server UUID, server address, or workflow log containing personal data in an issue or pull request.
...
If a Telegram Bot Token was exposed, revoke it with BotFather and replace the corresponding GitHub Actions secret.
